...
import 'package:cowsandbulls/Models/game.dart';
import 'package:cowsandbulls/Models/player.dart';
...
class DatabaseService {
  ...
  Stream<List<Player>> get player {
    return playerData.snapshots().map(_playerListFromSnapshot);
  }

  // get user doc stream
  Stream<UserData> get userData {
    return playerData.document(uid).snapshots().map(_userDataFromSnapshot);
  }

  // get game doc stream
  Stream<GameData> get gameData {
    return gamesData.document(uid).snapshots().map(_gameDataFromSnapshot);
  }
}
